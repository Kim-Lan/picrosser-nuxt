...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/h3/dist/index.mjs';
import { customAlphabet } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/nanoid/index.js';
import chunk from 'file:///home/kim-lan/picrosser-nuxt/node_modules/lodash.chunk/index.js';
import fs from 'fs';
import path from 'path';
import _$1 from 'file:///home/kim-lan/picrosser-nuxt/node_modules/lodash/lodash.js';
import { execSync } from 'child_process';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/devalue/index.js';
import destr from 'file:///home/kim-lan/picrosser-nuxt/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/kim-lan/picrosser-nuxt/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/consola/dist/index.mjs';
import devalue from 'file:///home/kim-lan/picrosser-nuxt/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/kim-lan/picrosser-nuxt/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/kim-lan/picrosser-nuxt/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/kim-lan/picrosser-nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/kim-lan/picrosser-nuxt/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/kim-lan/picrosser-nuxt/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/kim-lan/picrosser-nuxt/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/kim-lan/picrosser-nuxt/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _8mc4wkh3NE = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/home/kim-lan/picrosser-nuxt";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _Mg0E09Cmj1 = (nitroApp) => {
...
const _61AoJJBdPS = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _lazy_4oo1Kn = () => Promise.resolve().then(function () { return loadPuzzle_get$1; });
const _lazy_PuhvkI = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/loadPuzzle', handler: _lazy_4oo1Kn, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_PuhvkI, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_PuhvkI, lazy: true, middleware: false, method: undefined }
];
...
function convertIndexTo2D(index, width) {
...
function hasEmpty(grid) {
  ...
  for (let c = 0; c < grid[0].length; c++) {
    if (arraySum(getColumn(grid, c)) <= 0) {
      return true;
    }
  }
  return false;
}
function hasFull(grid) {
  if (grid.length === 0) {
    return false;
  }
  const size = grid.length;
  for (const row of grid) {
    if (arraySum(row) >= size) {
      return true;
    }
  }
  for (let c = 0; c < size; c++) {
    if (arraySum(getColumn(grid, c)) >= size) {
      return true;
    }
  }
  return false;
}
function hasSpace(grid, index) {
  const height = grid.length;
  const width = grid[0].length;
  const [row, col] = convertIndexTo2D(index, height);
...
function chooseCells(height, width) {
  ...
  const indexArray = total !== void 0 ? range(total) : [];
...
function bitGenerate(size) {
  ...
  do {
    ...
    solution2D = _$1.chunk(solution1D, size);
...
const loadPuzzle_get = defineEventHandler((event) => {
  const { height, width } = getQuery$1(event);
...
const loadPuzzle_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: loadPuzzle_get
});
...
const getClientManifest = () => import('file:///home/kim-lan/picrosser-nuxt/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/kim-lan/picrosser-nuxt/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
